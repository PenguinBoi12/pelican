...
def test_alter_column__with_new_type__expect_type_sql(
    pg_compiler: PostgreSQLCompiler,
) -> None:
...
def test_alter_column__with_nullable_false__expect_set_not_null_sql(
    pg_compiler: PostgreSQLCompiler,
) -> None:
...
def test_alter_column__with_nullable_true__expect_drop_not_null_sql(
    pg_compiler: PostgreSQLCompiler,
) -> None:
...
def test_alter_column__with_server_default__expect_set_default_sql(
    pg_compiler: PostgreSQLCompiler,
) -> None:
...
def test_alter_column__with_multiple_changes__expect_multiple_statements(
    pg_compiler: PostgreSQLCompiler,
) -> None:
    ddls = list(
...
def test_alter_column__with_no_changes__expect_error(
    pg_compiler: PostgreSQLCompiler,
) -> None:
