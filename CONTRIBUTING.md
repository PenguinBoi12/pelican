...
Thank you for your interest in contributing to Pelican! As an open source project, many kinds of contributions are welcome.
...
**Warning:** Non-trivial pull requests must have an [issue](https://github.com/PenguinBoi12/pelican/issues) proposing the changes.
...
The primary goal of these interactions is to ensure that, over time, everyone enjoys the best possible experience with Pelican and the feature you're implementing or fixing.
...
# Join the community
Need help, have some questions or want to participate more directly in the evolution of the project? Join my community on [Discord](https://discord.gg/6GEF9H9m) or [Matrix](https://matrix.to/#/%23codesociety:matrix.org)!
